...
<!-- OR if payments.php is in root -->
<link rel="stylesheet" href="static/css/style.css">
<style>
/* Page-specific modal styles that complement the main CSS */
.pm-overlay {
    display: none;
    position: fixed;
    inset: 0;
...
<div class="card">
    <form method="get" class="filter-form">
        ...
        <div style="flex:1;min-width:220px;">
            <label>Search Guest / Reservation #</label>
        ...
        <a href="?page=payments" class="btn-secondary">Today</a>
    </form>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (!empty($r['email'])): ?>
                                <br><span class="muted"><?php echo htmlspecialchars($r['email']); ?></span>
                            <?php endif; ?>
                            <?php if (!empty($r['phone_number'])): ?>
                                <br><span class="muted"><?php echo htmlspecialchars($r['phone_number']); ?></span>
                            <?php endif; ?>
                        </td>
                        ...
                        <td><?php echo $paid > 0 ? '&#8369;' . number_format($paid, 2) : '<span class="muted">—</span>'; ?></td>
